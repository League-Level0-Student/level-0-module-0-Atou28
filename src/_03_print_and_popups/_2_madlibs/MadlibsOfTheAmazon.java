...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		//Get the player to enter a liquid
		// The story below has has been written as a group of Strings joined together by + sign		// The story contains place holders, indicated by [** **] which you need to replace with
